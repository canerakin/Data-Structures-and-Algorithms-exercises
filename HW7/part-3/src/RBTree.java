public class RBTree<T extends Comparable<T>> {
    ...
    //wrap :find node x,so that x.key=<val and no node with key greater that x.key satisfies this condition.
    ...
    //wrap :find node x,so that x.key>=val and no node with key smaller that x.key satisfies this condition.
