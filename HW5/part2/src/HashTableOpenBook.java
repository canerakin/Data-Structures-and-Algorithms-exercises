/**
 * design hashtable with array
 * @param <K> generic key of value
 * @param <V> generic value of key
 */
public class HashTableOpenBook<K, V> implements KWHashMap<K, V> {
     ...
     * hashtable
     */
    private HashTableOpenBook.Entry<K, V>[] table;
    /**
     * started capacity
     */
     ...
     * to prevent leakage
     */
    private final HashTableOpenBook.Entry<K, V> DELETED = null;

    /**
     * no parameter constructor
     * create table
     */
    public HashTableOpenBook() {
        table = new HashTableOpenBook.Entry[START_CAPACITY];
    }
     ...
     */
    private void rehash() {
        HashTableOpenBook.Entry<K, V>[] oldTable = table;
        table = new HashTableOpenBook.Entry[2 * oldTable.length + 1];
